            ...
            <Fragment>
                ...
                {this.state.checklistitems.length > 0 ? (
                    <Paper elevation={1} className={classes.checklistitems}>
                        ...
                        <List>
                        {orderBy(this.state.checklistitems, ['updatedAt', 'body'], ['asc', 'desc']).map(checklistitem => (
                            <ListItem key={checklistitem.id} button component={Link} to={`/checklistitems/${checklistitem.id}`}>
                                ...
                                <ListItemSecondaryAction>
                                    <IconButton onClick={() => this.deleteItem(checklistitem)} color="inherit">
                                        <DeleteIcon />
                                    </IconButton>
                                </ListItemSecondaryAction>
                ...
                <Route exact path="/checkilistitems/:id" render={this.renderChecklistEditor} />
            </Fragment>
